...
class ViewController: UIViewController {
    ...
    func calculation(calcNum1: String, calcNum2: String){
        ...
        if intNum2 == 0 {
            tfDivisionQuotient.text = "N/A"
            tfDivisionRemainder.text = "N/A"
            lblMessage.text = "나누는 수는 0일 수 없습니다."
        }
        else {
            tfDivisionQuotient.text = "\(intNum1 / intNum2)"
            tfDivisionRemainder.text = "\(intNum1 % intNum2)"
